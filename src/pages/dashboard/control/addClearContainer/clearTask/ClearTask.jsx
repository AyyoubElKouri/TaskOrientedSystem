    ...
    return (
        <>
            <div className="flex flex-col sm:flex-row gap-5 mt-6 max-w-md mx-auto">
                {/* Bouton Supprimer tâches complétées */}
                <button
                    onClick={clearCompletedTasks}
                    className="flex items-center justify-center gap-2 px-5 py-2 border-2 border-yellow-500 text-yellow-500 rounded-lg font-semibold transition duration-300
                               hover:bg-yellow-500 hover:text-gray-900 focus:outline-none focus:ring-4 focus:ring-yellow-400 focus:ring-opacity-50"
                >
